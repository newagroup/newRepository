...
import com.yzit.common.collect.MapUtils;
import com.yzit.common.io.PropertiesUtils;
import com.yzit.common.lang.StringUtils;
import com.yzit.common.mapper.JsonMapper;
import com.yzit.common.mapper.XmlMapper;
import com.yzit.common.core.text.Convert;

/**
 * Http与Servlet工具类.客户端工具类
 * 
 * @author ThinkGem
 * @version 2014-8-19
 */
public class ServletUtils {
	...
	/**
	 * 获取当前相应对象 web.xml: <filter><filter-name>requestContextFilter</filter-name>
	 ...
	 * @param data
	 *            消息数据
	 * @return JSON字符串：{result:'true',message:'', if map then
	 *         key:value,key2:value2... else data:{} }
	 */
	...
	public static String renderResult(String result, String message, Object data) {
		...
		if (request != null) {
			...
			if (StringUtils.endsWithIgnoreCase(uri, ".xml")
					|| StringUtils.equalsIgnoreCase(request.getParameter("__ajax"), "xml")) {
	 ...
	 *            渲染对象：{result:'true',message:'',data:{}}
	 * @param result
	 *            结果标识：Global.TRUE or Globle.False
	 * @param message
	 *            执行消息
	 * @param data
	 *            消息数据
