...
import com.yzit.common.core.text.StrFormatter;
import com.yzit.common.codec.EncodeUtils;
import com.yzit.common.collect.ListUtils;
...
public class StringUtils extends org.apache.commons.lang3.StringUtils {
	...
	// 0px; margin: 0px; padding-left: 0px; letter-spacing: normal;
	// padding-right: 0px; font: 14px/25px 宋体, tahoma, arial, sans-serif;
	// white-space: normal; color: rgb(0,0,0); word-spacing: 0px; padding-top:
	// 0px; -webkit-text-stroke-width: 0px\">__eol__
	...
	// -webkit-text-stroke-width: 0px\">__eol__
	...
	// html += "<div style=\"text-indent: 32pt\">__eol__ <span
	// style=\"line-height: 20px; font-size: 20px\"><span style=\"font-family:
	// 宋体\">我市积极支持和引导企业、高校院所&ldquo;走出去&rdquo;开展国际科技合作，在国外集聚和利用各种创新资源，增强我市企业和科研院所竞争实力。</span></span></div>__eol__<div
	// align=\"left\" style=\"text-align: left; text-indent: 32pt;
	// text-autospace: \">__eol__ <span style=\"line-height: 20px; font-size:
	// 20px\"><span style=\"font-family:
	...
	// black\">年，我市企业与大学科研机构与国外共建7家联合研发中心。
	// </span></span></span></div>__eol__<div style=\"text-indent:
	// 32pt\">__eol__ <span style=\"line-height: 20px; font-size: 20px\"><span
	// style=\"font-family: 宋体\"><span style=\"color:
